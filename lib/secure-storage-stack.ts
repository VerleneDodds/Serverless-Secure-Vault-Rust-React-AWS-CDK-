...
export class SecureStorageStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Add GSI for folder-based listing: Query by PK (VAULT#id) + ParentID
    metadataTable.addGlobalSecondaryIndex({
      indexName: 'FolderIndexV2',
      partitionKey: { name: 'PK', type: dynamodb.AttributeType.STRING },
    ...
    // Proxy integration to delegate all routing and CORS logic to the Rust Lambda
